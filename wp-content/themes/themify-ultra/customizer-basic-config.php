...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'sticky_header_imageselect' => array(
			...
			'selector' => '.fixed-header-on #site-logo',
			'prop' => 'logo',
		),
		...
		'mobile_menu_panel_background' => array(
			...
			'selector' => '.mobile_menu_active.header-leftpane #headerwrap, .mobile_menu_active.header-rightpane #headerwrap, .mobile_menu_active #headerwrap .sidemenu-on',
			'prop' => 'background',
			'global' => true,
		),
		...
		'mobile_menu_panel_link_color' => array(
			...
			'selector' => '.mobile_menu_active.header-leftpane #headerwrap a, .mobile_menu_active.header-rightpane #headerwrap a, .mobile_menu_active #headerwrap .sidemenu.sidemenu-on a',
			'prop' => 'color',
			'global' => true,
		),
		...
		'mobile_menu_icon_background' => array(
			...
			'selector' => '.header-leftpane.mobile_menu_active #pagewrap.site #headerwrap #menu-icon, .header-rightpane.mobile_menu_active #pagewrap.site #headerwrap #menu-icon, .header-slide-out .menu-icon-wrapper, body:not(.header-leftpane):not(.header-rightpane).mobile_menu_active .menu-icon-wrapper',
			'prop' => 'background',
			'global' => true,
		),
		'mobile_menu_icon_padding' => array(
			...
			'selector' => '.header-leftpane #menu-icon, .header-rightpane #menu-icon, .header-slide-out .menu-icon-wrapper,  body:not(.header-leftpane):not(.header-rightpane).mobile_menu_active .menu-icon-wrapper',
			'prop' => 'padding',
		),
		...
		'mobile_menu_icon_color' => array(
			...
			'selector' => '.header-leftpane.mobile_menu_active #pagewrap.site #headerwrap #menu-icon, .header-rightpane.mobile_menu_active #pagewrap.site #headerwrap #menu-icon, #headerwrap #menu-icon',
			'prop' => 'color',
			'global' => true,
		),
		...
		'back_top_arrow_color' => array(
			...
			'selector' => '#footerwrap .back-top a:before',
			'prop' => 'color',
		),
