...
function themify_theme_enqueue_scripts() {
	...
	if ( $is_fullpage_scroll && (class_exists('Themify_Builder_Model') && !Themify_Builder_Model::is_front_builder_activate())) {
		...
		wp_enqueue_script( 'themify-fullpage', THEME_URI . '/js/fullpagescroll.php', array( 'jquery', 'jquery-effects-core' ), $theme_version, true );
	}
...
if ( ! function_exists( 'themify_theme_custom_post_css' ) ) {
	...
	function themify_theme_custom_post_css() {
		...
		if ( ! is_archive() && ( in_array( get_post_type(), array( 'post', 'page', 'portfolio', 'product' ) ) || themify_is_shop() ) ) {
			$post_id = get_the_ID();
...
if ( ! function_exists( 'themify_theme_body_class' ) ) {
	...
	function themify_theme_body_class( $classes ) {
		...
		// Skin Styles
		if ( ! is_archive() && ( '' != themify_get( 'body_background_color' ) || '' != themify_get( 'body_background_image' ) || '' != themify_get( 'body_font' ) || '' != themify_get( 'body_text_color' ) || '' != themify_get( 'body_link_color' ) || '' != themify_get( 'heading_font' ) || '' != themify_get( 'heading_color' ) || '' != themify_get( 'scheme_background' ) || '' != themify_get( 'scheme_color' ) ) ) {
			$classes[] = 'skin-styles';
		}
		if( isset( $old_post ) ) {
			$post = $old_post;
